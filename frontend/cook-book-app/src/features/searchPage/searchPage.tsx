...
export const SearchPage: FunctionComponent<SearchPageProps> = (props: SearchPageProps) => {
    ...
    return (
        <div className="justify-center">
            <div className="my-12 rounded-sm mx-1.5 space-y-14 lg:space-y-0 lg:flex lg:space-x-5  lg:max-w-7xl min-w-[70%] lg:justify-center" >
                <div className=" border-gray-100 border-t shadow-lg px-2 py-5 lg:w-1/4 lg:max-w-96 justify-center">
                    <SearchBar inputText={searchTerm ?? ""} searchButtonHidden={true} search={search}></SearchBar>
                </div>
                <div className=" border-gray-100 border-t shadow-lg h-full w-full flex p-5 flex-wrap justify-around overflow-auto">
